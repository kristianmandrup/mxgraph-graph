...
const { mxDictionary, mxGraph, mxUtils, mxConstants } = mx;
...
export class Cells {
  ...
  isCellResizable(cell) {
    var result = mxGraph.prototype.isCellResizable.apply(this, cell);
   ...
   */
  cellLabelChanged(cell, value, _autoSize) {
    ...
    try {
      ...
      mxGraph.prototype.cellLabelChanged.apply(this, cell);
    } finally {
  ...
  cellsRemoved(cells) {
    ...
    mxGraph.prototype.cellsRemoved.apply(this, cells);
  }
  ...
  removeCellsAfterUngroup(cells) {
    ...
    mxGraph.prototype.removeCellsAfterUngroup.apply(this, cells);
  }
